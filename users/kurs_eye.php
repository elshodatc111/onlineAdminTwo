                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body py-2">
                                            <h4 class="card-title m-0 p-0 w-100 text-center">Kurs nomi</h4><hr class='p-0 m-0 mt-1'>
                                        </div>
                                        <table class="table">
                                            <?php
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-footer p-0 m-0 pt-1 ">
                                                <div class="row">
                                                    <div class="col-lg-4 col-12"><a href="kurs_lugat.php?CoursID=<?php echo $_GET['CoursID'] ?>&MavzuID=<?php echo $MavzuID; ?>" class="btn btn-primary p-1 w-100 my-1">Lug'atlar</a></div>
                                                    <div class="col-lg-4 col-12"></div>
                                                    <div class="col-lg-4 col-12"><a href="kurs_test.php?CoursID=<?php echo $_GET['CoursID'] ?>&MavzuID=<?php echo $MavzuID; ?>" class="btn btn-primary p-1 w-100 my-1">Testlar</a></div>
                                                </div>
                                            </p>
                                        </div>
                                    </div>

<div class="container-fluid bg-primary text-white p-5">
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <p class="card-text m-0 mt-1"> <i class="bi bi-phone"></i> +998 91 950 1101</p>
            <p class="card-text m-0 mt-1"> <i class="bi bi-envelope"></i> atkoteams@gmail.com</p>
            <p class="card-text m-0 mt-1"> <i class="bi bi-align-center"></i> Qarshi shaxar, Mustaqillik shox ko'chasi 2-uy</p>
        </div>
        <div class="col-lg-3">
